...
This guide provides comprehensive documentation for the **react-native-animations** skill in the custom-plugin-react-native plugin.
...
```bash
# Invoke the skill
claude "react-native-animations - [your task description]"

# Example
claude "react-native-animations - analyze the current implementation"
```
...
def implement_react_native_animations(input_data):
    """
    Implement react-native-animations functionality.
