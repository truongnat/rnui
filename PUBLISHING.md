...
_Lưu ý: Sau khi chạy xong, một file `.changeset/_.md` sẽ được tạo. Bạn cần **commit và push** file này lên GitHub cùng với code của bạn.\*
...
_Sau bước này, bạn nên commit với message kiểu `chore: release packages`._
