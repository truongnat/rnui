...
function useBottomSheet({
  ...
  const snapPoints = (0, import_react6.useMemo)(
    () => rawSnapPoints.map(resolveSnapPoint),
    [rawSnapPoints]
  );
  const maxHeight = (0, import_react6.useMemo)(() => Math.max(...snapPoints), [snapPoints]);
...
function useSelect({
  ...
  const displayLabel = (0, import_react9.useMemo)(() => {
