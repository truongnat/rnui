...
export declare function useBottomSheet({ snapPoints: rawSnapPoints, initialSnapIndex, onClose, onSnapChange, enableDismissOnSwipe, enableBackdrop, }?: UseBottomSheetOptions): UseBottomSheetReturn;
