...
function useAutocomplete({
  ...
  const [internalInput, setInternalInput] = (0, react_1.useState)(
    defaultInputValue
  );
  ...
  const setInputValue = (0, react_1.useCallback)(
    (next) => {
  ...
  const isSelected = (0, react_1.useCallback)(
    (v) => {
  ...
  const selectOption = (0, react_1.useCallback)(
    (v) => {
      let next;
      if (multiple) {
