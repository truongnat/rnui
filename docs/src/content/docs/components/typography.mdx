...
<ComponentPreview title="Live preview" description="Article-style type hierarchy on a card surface.">
...
### Display (Astryx geometric scale)

For hero banners, marketing headlines, and data callouts — not document headings or body content.

```tsx
<Typography variant="display1">Display 1 - hero</Typography>
<Typography variant="display2">Display 2 - $1.2M</Typography>
<Typography variant="display3">Display 3 - callout</Typography>
```
