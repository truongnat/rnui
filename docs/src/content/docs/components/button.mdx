...
<ComponentPreview
  title="Live preview"
  description="Hero actions and variant row — styled with RNUI semantic tokens."
>
...
Default corner radius is `radius.lg` (12px) — rounded, not pill-shaped. Solid and accent variants use soft elevation; outline and ghost stay flat.
