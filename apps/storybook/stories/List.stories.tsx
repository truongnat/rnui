...
import { ThemeProvider, ListData, ListItem, ListItemText, ListItemIcon, Badge, Typography } from "@truongdq01/ui";
  ...
  render: () => (
    <View style={{ flex: 1 }}>
      <ListData
        ...
        renderItem={({ item }: any) => (
          <ListItem divider onPress={() => { }} secondaryAction={item.badge ? <Badge label={item.badge} variant="brand" /> : undefined}>
