...
import { ThemeProvider, Alert, AlertTitle } from "@truongdq01/ui";
...
export const AllSeverities: Story = {
  render: (args: any) => (
    <View style={{ gap: 12 }}>
      <AlertWrapper {...args} severity="success" variant="standard">Success message</AlertWrapper>
      <AlertWrapper {...args} severity="warning" variant="outlined">Warning message</AlertWrapper>
      <AlertWrapper {...args} severity="error" variant="filled">Error message</AlertWrapper>
      <AlertWrapper {...args} severity="info" variant="standard">Info message</AlertWrapper>
    </View>
  ),
};
