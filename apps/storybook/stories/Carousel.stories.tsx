                ...
                renderItem={(item: SlideData, index: number) => {
                    ...
                    return (
                        <View style={{ flex: 1, backgroundColor: item.bg, alignItems: "center", justifyContent: "center" }}>
                            <Text style={{ color: textColor, fontSize: 24, fontWeight: "bold" }}>{item.label} {index + 1}</Text>
                        </View>
                    );
                }}
            />
        ...
        <View style={{ height: 250 }}>
            <Carousel
                ...
                renderItem={(item: SlideData, index: number) => {
                    ...
                    return (
                        <View style={{ flex: 1, backgroundColor: item.bg, alignItems: "center", justifyContent: "center" }}>
                            <Text style={{ color: textColor, fontSize: 24, fontWeight: "bold" }}>Looped {item.label} {index + 1}</Text>
                            <Text style={{ color: textColor, fontSize: 14, opacity: 0.8 }}>Swipe past end to wrap around</Text>
                        </View>
                    );
                }}
            />
