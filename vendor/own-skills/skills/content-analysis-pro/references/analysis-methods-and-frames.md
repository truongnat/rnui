...
| **Screenshots / clips from user**   | User exports **still images** or short clips via **phone, VLC, OS tools** — not FFmpeg on _your_ side | Coverage is **partial**; list **which** moments were seen                                |
